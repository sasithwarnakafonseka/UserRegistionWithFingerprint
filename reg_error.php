    ...
    <section id="signup">
      ...
      <div class="form" >
          ...
          <form action="" method="POST" role="form" class="contactForm">
			    ...
			    <header >
         <center> <h3 class="section-title"><font color="red">ERROR IN REGISTRATION!</font></h3></center>
        </header>
			  <div class="container-login100-form-btn">
						<button type="button"  class="login100-form-btn" onclick="window.location.href='index.php#signup'">
							TRY AGAIN
						</button>
					</div>
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<form method="post" action="process/login.php" class="login100-form validate-form">
